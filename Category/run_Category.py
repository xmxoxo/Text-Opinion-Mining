...
flags.DEFINE_string("task_name", 'category', "The name of the task to train.")
...
class CategoryProcessor(DataProcessor):
  ...
  def get_labels(self):
    #return ["0", "1", "2"]
    return ['整体','使用体验','功效','价格','物流','气味',
        '包装','真伪','服务','其他','成分','尺寸','新鲜度']
...
def main(_):
  ...
  processors = {
      "category": CategoryProcessor, #2019/8/28 属性分类
  }
